...
public class SinkFilter extends FilterFramework
{
	public void run()
    {
		...
		*************************************************************************************/
		...
		try {
			writer = new FileWriter("OutputB.csv");
		...
		while (true)
		{
			try
			{
				...
				****************************************************************************/
				...
				/****************************************************************************
				// Here we look for an ID of 2 or 5 which indicates this is an altitude measurement.
				// If it is 5, change altUpdate accordingly
				****************************************************************************/
				if ( id == 2 || id == 5)
				{
					if (id ==  5)
				...
				****************************************************************************/
				if ( id == 4)
				{
					...
					try {
						...
						writer.write(altitude + (altUpdate ? "*" : "") + ",");		// append an * if id states this value has been updated
						writer.write(pressure + ",");
						writer.write(temperature + "\n");
					} catch(IOException e) {
						e.printStackTrace();
					}
					altUpdate = false;		// can now reset boolean since this frame is complete
				}
			}
			/*******************************************************************************
